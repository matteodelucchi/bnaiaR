...
tools:::makeLazyLoadDB(e2, paste0(FILENAMEbase, FILENAME, filenamesuffix, "_paramBootAbnConsDAG"))
lazyLoad(paste0(FILENAMEbase, FILENAME, filenamesuffix, "_paramBootAbnConsDAG"))
```
## Max. parents plot 
...
```{r}
cons.dag.stren <- apply(consDAGlist$consDAG, 1:2, mean)
cons.dag.threshold <- arc.stren.threshold(cons.dag.freq)
