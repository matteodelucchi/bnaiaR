...
if (SAVEPLOTS){
  ggsave(plot = plt, filename = "logreg_IArupture.png", path = PLOTPATH, dpi = 600)
} else {
  plt
}
```
...
if (SAVEPLOTS){
  ggsave(plot = plt, filename = "logreg_IArupture_allvars.png", path = PLOTPATH, dpi = 600)
} else {
  plt
}
```
