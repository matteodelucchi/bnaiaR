...
```{r}
gam_mod_aic <- AIC(gam_model_1, gam_model_2, gam_model_3, gam_model_4, gam_model_5, gam_model_6, gam_model_7)
gam_mod_aic[order(gam_mod_aic$AIC),]

gam_mod_bic <- BIC(gam_model_1, gam_model_2, gam_model_3, gam_model_4, gam_model_5, gam_model_6, gam_model_7)
