...
```{r}
rocdf_4.5 <- readRDS(file = paste0(PLOTPATH, "/expABNmultinomial4.5_cvROCAUC.rds")) # generated in 'continuous_ABN_SL_postprocessing.Rmd'
rocdf_4.5 <- rocdf_4.5$rocdf
...
rbind(rocdf_4.5, rocdf, rocdf_me, rocdf_meSizeLocRest) %>%
