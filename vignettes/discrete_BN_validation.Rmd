...
```{r}
(tabu_th03_fit$Smoking_Current_Former_No$prob)
```

```{r}
sim = cpdist(tabu_th03_fit, nodes = c("Smoking_Current_Former_No", "Ruptured_IA"), n = 10^4, evidence = (Gender == "Female" | Gender == "Male"))
plot(sim, col = "grey")
```
