...
df.cvmetrics <- data.frame(loocv.dbn.clerr.bic.part = c(cv.metrics(xval.rupture.bic.part, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.rupture.bic.part, returnConfMat = T)$carret_confmat$byClass),
                           loocv.dbn.clerr.bic = c(cv.metrics(xval.rupture.bic, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.rupture.bic, returnConfMat = T)$carret_confmat$byClass),
                           loocv.dbn.clerr.custom = c(cv.metrics(xval.rupture.bic.custom, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.rupture.bic.custom, returnConfMat = T)$carret_confmat$byClass))
df.cvmetrics
```
...
df.cvmetrics.postclerr <- data.frame(loocv.dbn.postclerr.bic.part = c(cv.metrics(xval.bic.bayes.part, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.bic.bayes.part, returnConfMat = T)$carret_confmat$byClass),
                           loocv.dbn.postclerr.bic = c(cv.metrics(xval.bic.bayes, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.bic.bayes, returnConfMat = T)$carret_confmat$byClass),
                           loocv.dbn.postclerr.custom = c(cv.metrics(xval.bic.custom.bayes, returnConfMat = T)$carret_confmat$overall, cv.metrics(xval.bic.custom.bayes, returnConfMat = T)$carret_confmat$byClass))
df.cvmetrics <- cbind(df.cvmetrics, df.cvmetrics.postclerr)
df.cvmetrics <- round(df.cvmetrics, 3)
df.cvmetrics
```
