...
```{r}
# TODO: Split train test data with study source
...
y_predProb <- predict(mod_glmer, data[1:10,], type = "response")
...
pred <- predict(object = train_mod, data = test_dat, node = "IAruptured", prob = TRUE, method = "bayes-lw")
